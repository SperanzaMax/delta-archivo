...
# 2026-09-06 · PREREG_SELLO_RELATIVO. Sin exportarlos, `tramo_abst.sh` usa sus defaults y las seis
# unidades corren con el sello ABSOLUTO, o sea son una copia del control ya corrido. Es exactamente
# el error que se cazo con FORMAS_Q el 2-sep, mirando que la variable no apareciera en NINGUNO de
# los dos scripts del pipeline.
export SELLO="${SELLO:-abs}"
export PERT="${PERT:-0}"
