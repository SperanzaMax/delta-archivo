"""Juez del kernel 5 · criterios de PREREG_KERNEL_Q5.md (SHA 50c4503d), escritos ANTES del dato.
...
TRAT = ["kq3_s0", "kq3_s1", "kq3_s2"]
CTRL = ["v3_s0", "v3_s1", "v3_s2"]
META = 26000
...
def main():
    print("=" * 96)
    print("KERNEL 5 · ¿la query, pudiendo VER la relacion, nota que eso no esta?  SHA 50c4503d")
    print("=" * 96)
    filas = {}
    for u in TRAT + CTRL:
        m = metricas(u)
